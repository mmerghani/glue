...
if (window.location.protocol === 'file:') {
  contextBridge.exposeInMainWorld('cloudcliDesktop', {
    ...
    openLocal: (selectedLocalModel) => ipcRenderer.invoke('cloudcli-desktop:open-local', selectedLocalModel),
    openLocalWebUi: (selectedLocalModel) => ipcRenderer.invoke('cloudcli-desktop:open-local-web-ui', selectedLocalModel),
