...
function showSandboxHelp(output: CliOutput): void {
  output.log(`
${terminalTextStyles.bright('Glue Sandbox')} — Run Glue inside Docker Sandboxes
...
Subcommands:
  ...
  ${terminalTextStyles.bright('logs')}         Show Glue server logs
    ...
    async execute(argumentsList) {
      ...
      switch (options.subcommand) {
        ...
        case 'start': {
          ...
          dependencies.output.log(`${terminalTextStyles.info('▶')} Launching Glue web server...`);
          dependencies.runSandboxCommand([
            'exec',
            sandboxName,
            'bash',
          ...
          dependencies.output.log(`\n${terminalTextStyles.ok('✔')} ${terminalTextStyles.bright('Glue is ready!')}`);
        ...
        case 'create': {
          ...
          dependencies.output.log(`\n${terminalTextStyles.bright('Glue Sandbox')}`);
