 ...
 * checked out in the main worktree), last-commit metadata, and the Glue
...
/**
 * Input accepted when registering an existing worktree as a Glue project.
 *
...
/**
 * Project view returned after a worktree is opened in Glue.
 *
